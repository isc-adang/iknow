...
ifeq ($(findstring $(PLATFORM), lnxubuntux64 lnxrhx86 lnxrhppc64 lnxdebarm macx64 macosuniversal lnxrharm64 lnxrhppc64le), $(PLATFORM))
#Similar problem on AIX xlC, but can't isolate the optimizations
#there: No documentation on specific flags.
ifeq ($(findstring $(PLATFORM), lnxubuntux64 lnxrhx86 macx64 macosuniversal lnxrharm64 lnxrhppc64le), $(PLATFORM))
