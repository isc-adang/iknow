...
# Build manylinux wheels for Python 3.6 through Python 3.11. This script must be
...
for PYTHON in /opt/python/{cp36-cp36m,cp37-cp37m,cp38-cp38,cp39-cp39,cp310-cp310,cp311-cp311}/bin/python
do
