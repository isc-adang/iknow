...
PYVERSIONS_WIN="3.6.8 3.7.9 3.8.10 3.9.13 3.10.8 3.11.0"
...
CCACHE_URL=https://github.com/ccache/ccache/releases/download/v4.7.2/ccache-4.7.2-windows-x86_64.zip
CYTHON_VERSION=0.29.32
MANYLINUX2014_X86_64_TAG=2022-11-06-7be974c
MANYLINUX2014_AARCH64_TAG=2022-11-06-7be974c
MANYLINUX2014_PPC64LE_TAG=2022-11-06-7be974c
